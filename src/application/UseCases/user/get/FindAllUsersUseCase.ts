...
import { FindAllUsersDTOOutput } from "../../../DTOs/user/get/FindAllUsersDTO";
import { UseCase } from "../../../UseCase";

export class FindAllUsersUseCase implements UseCase<void, FindAllUsersDTOOutput>{
    constructor(private readonly userRepo:UserRepository){}
    async execute(): Promise<FindAllUsersDTOOutput> {
        try {
