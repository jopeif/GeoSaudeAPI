...
import { FindUserByEmailDTOInput, FindUserByEmailDTOOutput } from "../../../DTOs/user/get/FindUserByEmailDTO";
import { UseCase } from "../../../UseCase";

export class FindUserByEmailUseCase implements UseCase<FindUserByEmailDTOInput, FindUserByEmailDTOOutput>{
    constructor(private readonly userRepo:UserRepository){}
    async execute(input: FindUserByEmailDTOInput): Promise<FindUserByEmailDTOOutput> {
