...
import { FindAllAgentDTOOutput } from "../../../DTOs/user/get/FindAllAgentsDTO";
import { UseCase } from "../../../UseCase";

export class FindAllAgentUseCase implements UseCase<void, FindAllAgentDTOOutput>{
    constructor(private readonly userRepo:UserRepository){}
    async execute(): Promise<FindAllAgentDTOOutput> {
        try {
            const users = await this.userRepo.findByRole("AGENT")
