...
import { FindUserByIdDTOInput, FindUserByIdDTOOutput } from "../../../DTOs/user/get/FindUserByIdDTO";
import { UseCase } from "../../../UseCase";

export class FindUserByIdUseCase implements UseCase<FindUserByIdDTOInput, FindUserByIdDTOOutput>{
    constructor(private readonly userRepo:UserRepository){}
    async execute(input: FindUserByIdDTOInput): Promise<FindUserByIdDTOOutput> {
